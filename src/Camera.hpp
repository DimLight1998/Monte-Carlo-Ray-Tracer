...
Camera::Camera(
    const glm::vec3 &lookFrom, const glm::vec3 &lookAt, const glm::vec3 &upDirection,
    float verticalFov, float aspect, float aperture, float focusDistance, float timeStart, float timeEnd)
{
...
const glm::vec3 &Camera::GetPhotoBottomLeftLocation() const
{
    return _photoBottomLeftLocation;
}

const glm::vec3 &Camera::GetPhotoLeftRightVec() const
{
    return _photoLeftRightVec;
}

const glm::vec3 &Camera::GetPhotoBottomTopVec() const
{
    return _photoBottomTopVec;
}

const glm::vec3 &Camera::GetEyeLocation() const
{
    return _eyeLocation;
}
...
const glm::vec3 &Camera::GetW() const
{
    return _w;
}
...
float Camera::GetTimeStart() const
{
    return _timeStart;
}

float Camera::GetTimeEnd() const
{
    return _timeEnd;
}
